import ameliaImg from "../img/name.jpg";
import mumImg from "../img/mum.jpg";

export default [
  {
    img: ameliaImg,
    title: "Personalised Description Name Frame",
    subtitle: "A hand-made fully customisable, personalised descriptive name frame",
    href: "/creates/#frames",
    color: "#ff7878",
  ...
  {
    img: mumImg,
    title: "Personalised Mum Frame",
    subtitle: "A hand-made ",
    href: "/chatter",
    redirect: true,
    featured: true,
    color: "#ffc608",
